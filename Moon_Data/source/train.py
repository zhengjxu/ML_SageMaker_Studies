...
if __name__ == '__main__':
    ...
    # Model parameters
    parser.add_argument("--input-dim", type=int, metavar='Input_Dimension', help="Input Dimension")
    parser.add_argument("--hidden-dim", type=int, metavar="Hidden_Dimension", help="Hidden Dimension")
    parser.add_argument("--output-dim", type=int, metavar="Output_Dimension", help="Output Dimension")
